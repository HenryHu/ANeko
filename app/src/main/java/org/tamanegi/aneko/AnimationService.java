...
public class AnimationService extends Service
{
    ...
    public void onCreate()
    {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            mChannel = new NotificationChannel(NOTIF_CHANNEL_ID, name, importance);
    ...
    private void setForegroundNotification(boolean start)
    {
        ...
        */
        ...
        builder.setContentText(getString(start ? R.string.notification_enable :
                R.string.notification_disable));
        builder.setSmallIcon(start ? R.drawable.mati1 : R.drawable.sleep1);
    ...
    {
        private double cur_x = 0;
        private double cur_y = 0;
        private double target_x = 0;
        private double target_y = 0;
        private double vx = 0;                   // pixels per sec
        private double vy = 0;                   // pixels per sec
        ...
        private void updateState()
        {
            ...
            double vec = Math.sqrt(vx * vx + vy * vy);
        ...
        private void setTargetPosition(double x, double y)
        {
            ...
            if(BEHAVIOURS[cur_behaviour_idx] == Behaviour.closer) {
                ...
                double dx = display_width / 2f - x;
                double dy = display_height / 2f - y;
                if(dx == 0 && dy == 0) {
                ...
                double nx = cur_x + r * Math.cos(a);
                double ny = cur_y + r * Math.sin(a);
        ...
        private void setTargetPositionDirect(double x, double y)
        {
            target_x = x;
            target_y = y;
        }
